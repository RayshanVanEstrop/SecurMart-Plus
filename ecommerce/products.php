...
<html lang="en">
    <head>
        ...
        <title>Products | SecurMart+</title>
        <!-- Bootstrap Core CSS -->
    ...
    <body>
        ...
        <div class="container" id="content">
			<h1 align="center">Our Selections</h1>
                    ...
                    <div class="col-sm-3">
                        <a href="products.php#shirts" >
                            <div class="thumbnail">
                                ...
                                <div class="caption">
                                    <h3>Shirts</h3>
                                    <p>Our exquisite collection of shirts.<br> Casual n Official</p>
                                </div>
                            </div>
                        </a>
                    </div>
			...
			<h2 align="center">Shoes & Foot wear</h2>
            <div class="row text-center" id="shoes">
                <div class="col-md-3 col-sm-6 home-feature">
                    <div class="thumbnail">
                        <img src="img/11.jpg" alt="">
                        <div class="caption">
                            <h3>Blu' DIFFERENTE</h3>
                ...
                <div class="col-md-3 col-sm-6 home-feature">
                    <div class="thumbnail">
                        ...
                        <div class="caption">
                            <h3>Leve-Brw Boots </h3>
                            <p>Price: Rs. 15750.00 </p>
                            <!--User has to login to purchase the items-->
                            <?php if (!isset($_SESSION['email'])) { ?>
                                <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                <?php
			...
			<h2 align="center">Office & Casual wear</h2>
			...
			<h2 align="center">Watches & Cameras</h2>
			...
			<div class="row text-center" id="watches&cameras">
                <div class="col-md-3 col-sm-6 home-feature">
                    <div class="thumbnail">
                        <img src="img/10.jpg" alt="">
                        <div class="caption">
